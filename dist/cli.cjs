...
function getGitRepoName() {
  try {
    const topLevel = (0, import_child_process2.execSync)("git rev-parse --show-toplevel", { encoding: "utf-8", stdio: ["pipe", "pipe", "ignore"] }).trim();
    return (0, import_path.basename)(topLevel);
  } catch {
    return (0, import_path.basename)(process.cwd());
  }
}
  ...
  try {
    if (opts.json) {
      ...
      if (opts.json === "-") {
        ...
        content = (0, import_fs.readFileSync)(opts.json, "utf-8");
      }
